            ...
            NavHost(
                ...
                composable(Routes.LOGIN) {
                    val viewModel = remember {
                        LoginViewModel(authRepository, usersRepository)
                    }
                    LoginScreen(
                        viewModel = viewModel,
                        onSignedIn = {
                ...
                composable(Routes.SIGNUP) {
                    val viewModel = remember {
                        SignupViewModel(authRepository, usersRepository)
                    }
                    SignupScreen(
                        viewModel = viewModel,
                        onSignedUp = {
                ...
                composable(Routes.MAIN) {
                    ...
                    val homeViewModel = viewModel {
                        HomeViewModel(authRepository, usersRepository)
                    }
                ...
                composable(Routes.CREATE_FLAT) {
                    val viewModel = viewModel {
                        CreateFlatViewModel(authRepository, flatsRepository)
                    }
                    CreateFlatScreen(
                        viewModel = viewModel,
                        onDone = {
                ...
                composable(Routes.JOIN_FLAT) {
                    val viewModel = viewModel {
                        JoinFlatViewModel(authRepository, flatsRepository)
                    }
                    JoinFlatScreen(
                        viewModel = viewModel,
                        onDone = {
                ...
                composable(Routes.SETTINGS) {
                    val viewModel = viewModel {
                        SettingsViewModel(authRepository, usersRepository)
                    }
                    SettingsScreen(
                        user = currentUser,
                        viewModel = viewModel,
